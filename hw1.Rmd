...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: Hello my name is **Joel Martin** I am a *Data Science* major and I am looking forward to learning about R and data in Data Science 202!
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: A job I believe is related to data science is a data scientist. You can read about a data scientists job [here](https://www.mastersindatascience.org/careers/data-scientist/)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I will be most interested in data related to movies.
